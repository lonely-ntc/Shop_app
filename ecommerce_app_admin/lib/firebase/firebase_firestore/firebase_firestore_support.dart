...
import 'package:ecommerce_app_admin/firebase/firebase_storage/firebase_storage_support.dart';
...
class FirebaseFirestoreSupport {
  static FirebaseFirestoreSupport instance = FirebaseFirestoreSupport();
  ...
  Future<CategoryModel> addSingleCategory(File image, String name) async {
    ...
    String imageUrl = await FirebaseStorageSupport.instance
